...
//		expansion_sum(int elen, REAL* e, flen, f, REAL* h)																		 
//		expansion_sum_zeroelim1(int elen, REAL* e, flen, f, REAL* h)													 
//		expansion_sum_zeroelim2(int elen, REAL* e, flen, f, REAL* h)													 
//		fast_expansion_sum(int elen, REAL* e, flen, f, REAL* h)																
//		fast_expansion_sum_zeroelim(int elen, REAL* e, flen, f, REAL* h)											 
//		linear_expansion_sum(int elen, REAL* e, flen, f, REAL* h)															
//		linear_expansion_sum_zeroelim(int elen, REAL* e, flen, f, REAL* h)										 
//		scale_expansion(int elen, REAL* e, REAL b, REAL* h)																				 
...
//void expansion_print(int elen, e)
//int elen;
//REAL* e;
//{
//	int i;
